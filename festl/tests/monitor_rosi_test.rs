...
use festl::stl::core::RobustnessInterval;
use festl::stl::formula_definition::FormulaDefinition;
use festl::stl::monitor::{Algorithm, DelayedQuantitative, Rosi, StlMonitor};
            ...
            .map(|formula| {
                ...
                signal
                    ...
                    .flat_map(|s| {
                        ...
                        let delayed_outputs = delayed_output.all_raw_outputs();
...
fn test_library_formulas_rosi(
    ...
    let lib_formulas = festl::stl::formulas::get_formulas(&[]);
