//! # FeSTL - Online Signal Temporal Logic
//!
//! `festl` provides runtime and macro-based tooling to parse, build, and execute
...
//! use festl::stl::monitor::{Algorithm, DelayedQuantitative, StlMonitor};
...
// Enable use of ::festl:: paths within this crate for the proc-macro
extern crate self as festl;
