"""
RoSI scalability analysis: execution time vs. temporal depth.

Line chart showing how RoSI performance scales with temporal bound,
comparing temporal operators (G, F, U).
"""
...
from config import (
    COLORS, LABELS_SHORT, OPERATOR_MARKERS, OPERATOR_LINESTYLES,
...
def plot_line_rosi(save: bool = True, show: bool = False) -> plt.Figure:
    """Create line chart for RoSI scalability across temporal depth."""
    ...
    if USE_AVERAGING_FORMULA:
        # Average F and G results together
        ...
        if f_pairs and g_pairs:
            ...
            if common_bounds:
                ...
                label = f"{LABELS_SHORT[semantic]}: {FORMULAS_LINE['6']}"
                ax.plot(
    ...
    ax.set_title("RoSI: Scalability with Temporal Depth")
    ...
    if save:
        _save_figure(fig, "plot4_temporaldepth_rosi_scalability")
...
if __name__ == "__main__":
    plot_line_rosi(save=True, show=True)
