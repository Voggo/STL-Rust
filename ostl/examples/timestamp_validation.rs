...
fn main() {
    ...
    println!("   Outputs: {}", output1.total_raw_outputs());
    ...
    println!("   Outputs: {}", output2.total_raw_outputs());
    ...
    println!(
        "   Outputs: {} (step was ignored)",
        output3.total_raw_outputs()
    );
    ...
    println!("   Outputs: {}", output5.total_raw_outputs());
